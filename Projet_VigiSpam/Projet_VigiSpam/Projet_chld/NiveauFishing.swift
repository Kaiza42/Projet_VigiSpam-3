    ...
    var body: some View {
        ...
        NavigationView{
            ...
            ZStack{
                ...
                //Bonus 1
                NavigationLink(destination: Question3(question: QuestionsFishing[6], level: 1)){
                    Text("Bonus")
                        .font(.system(size: 25))
                        .bold()
                ...
                //Bonus 2
                NavigationLink(destination: Question3(question: QuestionsFishing[11], level: 1)){
                    Text("Bonus")
                        .font(.system(size: 25))
                        .bold()
                        .frame(width:130 ,height: 130)
