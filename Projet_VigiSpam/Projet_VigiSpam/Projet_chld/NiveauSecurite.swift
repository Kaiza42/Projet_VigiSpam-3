...
//Bonus 1
                NavigationLink(destination: Question3(question: QuestionsSecurite[6], level: 1)){
                Text("Bonus")
                        .font(.system(size: 25))
                        .bold()
...
//Bonus 2
                NavigationLink(destination: Question3(question: QuestionsSecurite[11], level: 1)){
                Text("Bonus")
                        .font(.system(size: 25))
                        .bold()
                    .frame(width:130 ,height: 130)
